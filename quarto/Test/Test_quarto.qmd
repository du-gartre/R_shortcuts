...
It lets you find any text that matches your search in *all the files that are under your working directory* or
in an specified directory. It will list you all the matches by the files where they are located. Just as
