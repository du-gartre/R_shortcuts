...
author: "David U. Garibay-Treviño, MPP."
date: "2023-10-16"
...
In this brief tutorial I will try my best to share some of the most used shortcuts in RStudio, according to my experience and to that of other users that have also talked on the subject (check @sec-ref). To make this tutorial a little bit more intuitive. I will break the shortcuts in the next categories:
...
The **Go to file/function** shortcut brings up a search box that allows you to:
